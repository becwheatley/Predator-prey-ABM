...
to setup-target-patches
  ...
  [
    ...
    [ ;; if there are obstacles
      ...
      ;; attractiveness
      ifelse predator-agility < prey-agility ;; if the predator is less agile than the prey
      [
...
@#$#@#$#@
<experiments>
  <experiment name="cheetah vs impala - open savanna" repetitions="500" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    ...
    <enumeratedValueSet variable="prey-max-velocity">
      <value value="13.8"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="prey-agility">
      <value value="3.429"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="prey-acceleration">
      <value value="5.7"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="prey-deceleration">
      <value value="6.3"/>
    </enumeratedValueSet>
    ...
    <enumeratedValueSet variable="predator-max-velocity">
      <value value="19.9"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="predator-agility">
      <value value="3.569"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="predator-acceleration">
      <value value="8.3"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="predator-deceleration">
      <value value="10.6"/>
    </enumeratedValueSet>
  ...
  <experiment name="cheetah vs impala - acacia thicket" repetitions="100" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>number-obstacles</metric>
    <metric>count patches with [ pcolor = brown ] / count patches</metric>
